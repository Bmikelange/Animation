...
$(OBJDIR)/CalculsSPH.o: src/master_MecaSim/src-etudiant/CalculsSPH.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
...
$(OBJDIR)/ObjetSimuleSPH.o: src/master_MecaSim/src-etudiant/ObjetSimuleSPH.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
